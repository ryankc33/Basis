...
describe "lifequotes/new" do
  before(:each) do
    assign(:lifequote, stub_model(Lifequote,
      :cover_amount => "9.99",
      :cover => "MyString",
      :cover_type => "MyString",
  ...
  it "renders new lifequote form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", lifequotes_path, "post" do
