...
describe LifeInsurancesController do
  ...
  let(:valid_attributes) { { "reviewable" => "false" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved life_insurance as @life_insurance" do
        ...
        post :create, {:life_insurance => { "reviewable" => "invalid value" }}, valid_session
        assigns(:life_insurance).should be_a_new(LifeInsurance)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested life_insurance" do
        ...
        LifeInsurance.any_instance.should_receive(:update).with({ "reviewable" => "false" })
        put :update, {:id => life_insurance.to_param, :life_insurance => { "reviewable" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the life_insurance as @life_insurance" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        LifeInsurance.any_instance.stub(:save).and_return(false)
        put :update, {:id => life_insurance.to_param, :life_insurance => { "reviewable" => "invalid value" }}, valid_session
        assigns(:life_insurance).should eq(life_insurance)
      end
